...
SELECT *
FROM employees
WHERE first_name = 'Denis' AND first_name = 'Elvis'; --this doesn't return any output, the OR should be used instead of the AND
...
SELECT *
FROM employees
WHERE first_name LIKE('%ar%'); -- this finds the two letters in the center of words that are the same between the percentages
